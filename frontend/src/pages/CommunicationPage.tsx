...
export function CommunicationPage() {
  ...
  const receivers = agents.filter((item) => item.agentId !== senderId && item.status === "Active");
  const selectedSender = senders.find((item) => item.agentId === senderId); const selectedReceiver = agents.find((item) => item.agentId === receiverId);
